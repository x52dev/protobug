...
use super::{InputFormat, Inspector};

pub(super) fn compact_json(inspector: &Inspector) -> std::result::Result<String, Report<Inspect>> {
...
pub(super) fn join_lines(lines: Vec<String>, had_trailing_newline: bool) -> String {
...
pub(super) fn encode_line_output(
    inspector: &Inspector,
...
pub(super) fn apply_json_filter(
    json: &str,
    filter: &str,
) -> std::result::Result<String, Report<Inspect>> {
