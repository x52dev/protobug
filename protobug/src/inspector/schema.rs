...
use crate::error::{Inspect, InvalidSchema, MultipleTopLevelMessages, NoTopLevelMessages};

use super::{InputFormat, Inspector, decode};
...
pub(super) fn available_message_names(fd: &FileDescriptor) -> Vec<String> {
...
pub(super) fn load_file_descriptor(
    schema: &Utf8Path,
